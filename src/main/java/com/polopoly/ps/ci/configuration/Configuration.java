...
public class Configuration extends AbstractConfiguration {
	...
	private static final String DEFAULT_DISTRIBUTION_URL = 
			"http://support.polopoly.com/confluence/download/attachments/27821981/Polopoly_dist_10-4-0-0e345d8.jar";
    ...
    public ConfigurationFileValue getInstallScript() {
        return file("scripts.install.antscript", defaultToConfigurationFile(getProjectHomeDirectory(), "common/install.xml"),
    ...
    public ConfigurationFileValue getImportScript() {
        return file("scripts.import.antscript", defaultToConfigurationFile(getProjectHomeDirectory(), "common/import.xml"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationFileValue getWebPomDirectory() {
        return file("project.web.pom.directory", defaultToConfigurationFile(getProjectHomeDirectory(), "webapp-dispatcher"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationFileValue getGuiPomDirectory() {
        return file("project.gui.pom.directory", defaultToConfigurationFile(getProjectHomeDirectory(), "webapp-polopoly"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationFileValue getDemodataPomDirectory() {
        return file("project.demodata.pom.directory", defaultToConfigurationFile(getProjectHomeDirectory(), "src/resources"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationFileValue getContentPomDirectory() {
        return file("project.content.pom.directory", defaultToConfigurationFile(getProjectHomeDirectory(), "src/resources"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationFileValue getClientLibPomDirectory() {
        return file("project.clientlib.pom.directory", defaultToConfigurationFile(getProjectHomeDirectory(), "webapp-dispatcher"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationFileValue getProjectParentPomDirectory() {
        return file("project.parent.pom.directory", defaultToString(getProjectHomeDirectory().getConfigurationString()),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationIntegerValue getGuiServerStartupTimeoutSeconds() {
    	/**
    	 * The timeout is extremely long since if the caches are cold and there is lots of new data the startup can actually take this long. 
    	 */
    ...
    public ConfigurationFileValue getJbossStartupDirectory() {
        return file("jboss.start.directory", defaultToConfigurationFile(getJbossDirectory(), "bin"), getJbossDirectory());
    }
    ...
    public ConfigurationFileValue getPolopolyDistributionFile() {
        return file("polopoly.distribution.file", defaultToConfigurationFile(getProjectHomeDirectory(), "lib/polopoly-dist.jar") , getProjectHomeDirectory());
    }
    ...
    public ConfigurationUrlValue getJBossDistributionUrl() {
        return url("jboss.distribution.url",
    ...
    public ConfigurationFileValue getJBossDistributionFile() {
        return file("jboss.distribution.file", defaultToConfigurationFile(getProjectHomeDirectory(), "lib/jboss-4.0.5.GA.zip"),
                getProjectHomeDirectory());
    }
    ...
    public ConfigurationStringValue getPolopolyArtifact() {
        return string("polopoly.artifact",
                new DefaultArtifactValue("com.polopoly:polopoly:", getPolopolyVersion()));
    }
    ...
    public ConfigurationStringValue getHotdeployArtifact() {
        return string("tools.hotdeploy.artifact", 
                new DefaultArtifactValue("com.polopoly.ps.tools:hotdeploy:", getToolsVersion()));
    }
