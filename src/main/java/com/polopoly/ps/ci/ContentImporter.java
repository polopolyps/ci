...
public class ContentImporter {
    ...
    public void importDemoData(DirectoryJarNameMapping... directories) {
        ...
        importDirectories(append(directories,
                getMappedResourceDirectory(new Configuration().getDemodataPomDirectory().getValue())));
    ...
    public static File getResourceDirectory(File pomDirectory) {
        ...
        if (!resourcesDirectory.exists()) {
            ...
            System.out.println("Could not find resource directory " + resourcesDirectory + ". Falling back to target/classes.");
